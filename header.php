...
<body <?php body_class(); ?>>
<?php wp_body_open(); ?>
	<a class="msr-skip-link" href="#site-content"><?php esc_html_e( 'Skip to content', 'msrawards' ); ?></a>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container-fluid awards-navbar__inner d-flex align-items-center flex-wrap">
          ...
          aria-controls="site-header-mobile-nav" aria-expanded="false" aria-label="<?php esc_attr_e( 'Toggle navigation', 'msrawards' ); ?>">
        ...
        <div class="offcanvas offcanvas-end site-header__mobile-nav ms-lg-auto" tabindex="-1" id="site-header-mobile-nav" aria-labelledby="site-header-mobile-nav-label">
			<div class="offcanvas-header d-lg-none">
				<p class="offcanvas-title h6 mb-0" id="site-header-mobile-nav-label"><?php esc_html_e( 'Menu', 'msrawards' ); ?></p>
