	   <div id="awards-carousel-leaderboard-header" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
                  <div class="carousel-inner">
				   ...
				   <div class="col-md-4">
               		<div class="panel">
				<div class="my-auto">
				<p class="awards-advert__label text-center"><?php esc_html_e( 'Advertisement', 'msrawards' ); ?></p>
		  </div>
		  </div>
                </div>
                    <div class="col-md-8"> 
