...
if ( $next_post || $prev_post ) {
	...
	<nav class="pagination-single section-inner<?php echo esc_attr( $pagination_classes ); ?>" aria-label="<?php esc_attr_e( 'Post', 'msrawards' ); ?>">

		<hr class="styled-separator is-style-wide" aria-hidden="true" />
        <h1> View more <?php $category = get_the_category(); echo $category[0]->cat_name; ?> </h1>
