 ...
 * @return int
 */
function msrawards_sanitize_attachment_id( $attachment_id ) {
 ...
 * @return string
 */
function msrawards_sanitize_background_url( $url ) {
 ...
 * @return string
 */
function msrawards_hero_background_url( $value ) {
	return msrawards_sanitize_background_url( msrawards_acf_image_url( $value ) );
}
 ...
 */
function msrawards_get_acf_link_parts( $link ) {
	$parts = array(
		'url'    => '',
		'title'  => '',
		'target' => '_self',
 ...
 * @return void
 */
function msrawards_render_card_media( $post_id = null, $size = 'medium_large', $args = array() ) {
	$post_id = $post_id ? (int) $post_id : get_the_ID();
	$thumb_id = msrawards_sanitize_attachment_id( (int) get_post_thumbnail_id( $post_id ) );
	if ( ! $thumb_id ) {
		return;
	}
...
/**
 * Render single portrait frame (nominee/judge profile).
 *
 * @param int|null $post_id Post ID.
 * @param string   $size    Image size.
 * @return void
 */
function msrawards_render_single_media( $post_id = null, $size = 'large' ) {
	$post_id = $post_id ? (int) $post_id : get_the_ID();
	$thumb_id = msrawards_sanitize_attachment_id( (int) get_post_thumbnail_id( $post_id ) );
	if ( ! $thumb_id ) {
		return;
