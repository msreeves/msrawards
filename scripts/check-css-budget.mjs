#!/usr/bin/env node
/**
 * MSR Awards CSS budget gate (Phase 19).
 *
 * Usage: node scripts/check-css-budget.mjs
 * Env: MSR_AWARDS_CSS_BUDGET_BYTES (default 285000)
 */
...
const maxBytes = Number( process.env.MSR_AWARDS_CSS_BUDGET_BYTES || 360448 );
...
// Sanity: bundled CSS should reference self-hosted assets, not CDN hosts.
