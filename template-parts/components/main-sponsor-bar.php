...
?>
<section class="awards-main-sponsor" aria-label="<?php esc_attr_e( 'Main sponsor', 'msrawards' ); ?>">
	<div class="container">
		<p class="awards-main-sponsor__label"><?php esc_html_e( 'Main sponsor', 'msrawards' ); ?></p>
		<div class="awards-main-sponsor__logos">
			<?php foreach ( $sponsors as $sponsor ) : ?>
				...
				?>
				<?php if ( $sponsor_url ) : ?>
				<a class="awards-main-sponsor__logo awards-logo-tile" href="<?php echo esc_url( $sponsor_url ); ?>" target="_blank" rel="noopener noreferrer">
					<img src="<?php echo esc_url( $img_url ); ?>" alt="<?php echo esc_attr( $alt ); ?>" loading="lazy" decoding="async" />
				</a>
				<?php else : ?>
				<span class="awards-main-sponsor__logo awards-logo-tile">
					<img src="<?php echo esc_url( $img_url ); ?>" alt="<?php echo esc_attr( $alt ); ?>" loading="lazy" decoding="async" />
				</span>
				<?php endif; ?>
			<?php endforeach; ?>
