...
?>
<section id="advert">
<div id="awards-carousel-advert" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
                  <div class="carousel-inner">
                            <?php $count = 0; ?>
                            <?php foreach ( $slider as $slide ) : ?>
                                <?php setup_postdata( $slide->ID ); ?>
                                <div class="carousel-item <?php echo ( 0 === $count ) ? 'active' : ''; ?>">
                                   <div class="panel awards-advert-panel text-center">
				<p class="awards-advert__label mb-3"><?php esc_html_e( 'Advertisement', 'msrawards' ); ?></p>
                    <?php
					...
					if ( is_array( $link ) && ! empty( $link['url'] ) ) :
						...
						$link_label  = ! empty( $link['title'] ) ? (string) $link['title'] : __( 'Sponsored link', 'msrawards' );
