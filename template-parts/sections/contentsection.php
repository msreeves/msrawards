...
<section>
   <div class="container">
      <?php foreach ( $sections as $section ) :
		$video_html   = msrawards_render_video_embed( $section['video'] ?? '' );
		$heading      = $section['title'] ?? '';
		$image        = msrawards_acf_image_url( $section['image'] ?? '' );
      ...
      <div class="row g-0">
         <div class="col-sm-12">
            <div class="panel">
                  ...
                  <div class="msr-reveal msr-rich-text"><?php msrawards_render_rich_text( $introduction ); ?></div>
                    <?php if ( $video_html ) : ?>
                  ...
                  <p class="msr-video-unavailable" role="status"><?php esc_html_e( 'Video is temporarily unavailable. Refresh the page or check back later.', 'msrawards' ); ?></p>
                  <?php endif; ?>
            </div>
         </div>
      </div>
