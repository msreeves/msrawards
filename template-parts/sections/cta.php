...
<section class="<?php echo esc_attr( $section_class ); ?>">
	<div class="container">
		<div class="panel awards-cta-panel">
			<div class="row align-items-center g-4">
				<?php if ( $has_image ) : ?>
				<div class="col-lg-6">
					<div class="awards-cta-panel__media">
						<img
							class="awards-cta-panel__img"
				...
				<div class="<?php echo esc_attr( $has_image ? 'col-lg-6' : 'col-lg-10 mx-auto' ); ?>">
					<div class="awards-cta-panel__body text-center">
						<?php if ( $heading ) : ?>
						...
						<div class="awards-ctas ctas">
							<?php msrawards_render_cta_link( $args['link1'] ?? null ); ?>
							<?php msrawards_render_cta_link( $args['link2'] ?? null, 'btn btn-outline-primary' ); ?>
						</div>
					</div>
				</div>
			</div>
